...
// Build Data
// -- Data consists of a nested set of arrays  
const allQuotesbyCateogry = buildData();

//get random cateogry array -- eg. People, Literary Works, Films
const selectedCategoryArray = getRandomItem(allQuotesbyCateogry);

//get random quote array in selected Category -- e.g. Aristotle quotes, Laozi quotes, The Little Prince quotes depending on category  
const selectedQuoteArray = getRandomItem(selectedCategoryArray);

//get random quote object in selected Quote Array within selected Category 
...
function buildData() {
    ...
    // Return array of all quotes by Category
